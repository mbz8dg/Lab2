...
# DROP TABLE `fact_orders`;
 ...
 `fact_order_key` int not null auto_increment,
  ...
  `ship_state_province` varchar(45) DEFAULT NULL,
  `ship_zip_postal_code` varchar(45) DEFAULT NULL,
  `ship_country_region` varchar(45) DEFAULT NULL,
  `quantity` decimal (18,4) not null default '0.00000',
  ...
  `order_details_status` varchar(45) not NULL,
